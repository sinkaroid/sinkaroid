        ...
        <div class="modal-wrapper">
          ...
          >
            ...
            <div class="modal-body my-0 pb-0 px-4 pt-0">
              ...
              >
                <span>Sinkaroid {{ portfolio.pubDate }} • {{ portfolio.timeago }}</span>
              </div>
              ...
              <hr />
              <div>
                <Gallery :images="portfolio.pictures" align="right"/> <!-- bajingan -->
              </div>
            </div>
            ...
            <div class="text-center pb-3">
              ...
              <button class="btn w-25" @click="$emit('close')"><i class="fa fa-arrow-left"></i></button>
            </div>
          </div>
        </div>
      </div>
